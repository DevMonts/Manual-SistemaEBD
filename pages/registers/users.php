    ...
    <main class="max-w-4xl mx-auto p-6">
        <div class="bg-white shadow-md rounded-2xl p-8">
            ...
            <div class="text-center mb-6 ">
                <img src="/pages/assets/Users.png" class="mx-auto max-w-xs rounded-lg shadow-md m-10" />
                <img src="/pages/assets/User_Show.png" class="mx-auto max-w-xs rounded-lg shadow-md m-10" />
                <img src="/pages/assets/User_Edit.png" class="mx-auto max-w-xs rounded-lg shadow-md m-10" />
