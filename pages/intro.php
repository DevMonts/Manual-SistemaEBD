...
<body class="bg-gray-50 text-gray-800">
    <div class="max-w-6xl mx-auto px-4 py-8 space-y-16">
        <section id="intro" class="bg-white p-6 md:p-10 rounded-2xl shadow transition hover:shadow-lg">
        ...
        <section class="bg-white p-6 md:p-10 rounded-2xl shadow transition hover:shadow-lg">
            <h2 class="text-2xl font-bold text-orange-600 mb-4">Exemplo de Tela (Cadastro de Turmas)</h2>
            <div class="h-1 w-16 bg-orange-400 mb-6 rounded"></div>
            <div class="flex flex-col md:flex-row gap-10 items-center">
                <img src="assets/Class_Register.png" alt="Class Register"
