...
<body class="bg-gray-100 text-gray-900">
  ...
  <div class="flex h-screen">
    <aside class="w-64 p-5">
      <nav>
        <ul>
          <li class="py-2 text-gray-600 hover:text-orange-500"><a href="index.php">Introdução</a></li>
          <li class="py-2 text-gray-600 hover:text-orange-500 font-bold"><a href="page2.php">Barra de Navegação</a></li>
          <li class="py-2 text-gray-600 hover:text-orange-500"><a href="page3.php">Cadastros</a></li>
          <li class="py-2 text-gray-600 hover:text-orange-500"><a href="page4.php">Relatórios</a></li>
          <li class="py-2 text-gray-600 hover:text-orange-500"><a href="page5.php">Configurações</a></li>
        </ul>
      </nav>
    </aside>
