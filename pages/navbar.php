...
<head>
    ...
    <title>Barra de Navegação - Manual Sistema EBD</title>
    <style>
        body {
    ...
    <div class="max-w-6xl mx-auto px-4 py-8 space-y-12">
        ...
        <section class="bg-white p-6 md:p-8 rounded-2xl shadow transition hover:shadow-lg">
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                <img src="assets/Navbar.png" alt="Exemplo da barra inferior" class="max-w-[240px] md:max-w-[280px] w-full rounded-xl shadow-md">
                <ul class="text-gray-700 text-base md:text-lg leading-relaxed list-disc pl-4">
                    <li><strong>Menu:</strong> acessa o menu lateral do sistema (em alguns dispositivos)</li>
                    <li><strong>Início:</strong> exibe o painel inicial com os recursos principais</li>
                    <li><strong>Turmas:</strong> acessa a listagem de turmas cadastradas</li>
                    <li><strong>Cadastros:</strong> acessa o gerenciamento de usuários, departamentos, etc.</li>
                    <li><strong>Dados:</strong> exibe indicadores, médias, relatórios e dados estatísticos</li>
                </ul>
            </div>
        </section>
        <section class="bg-white p-6 md:p-8 rounded-2xl shadow transition hover:shadow-lg">
