...
<body class="bg-gray-100 text-gray-900 p-6">
    <a href="index.php" class="text-orange-600 hover:underline block mb-4">&larr;</a>
    <?php
    if (isset($_GET['q']) && !empty(trim($_GET['q']))) {
        ...
        if (count($results)) {
            ...
            foreach ($results as $res) {
                echo "<li><a href='index.php?q=" . urlencode($search) . "&open=" . urlencode($res['path']) . "' class='text-orange-600 hover:underline'>" . htmlspecialchars($res['title']) . "</a></li>";
            }
            echo "</ul>";
        } else {
